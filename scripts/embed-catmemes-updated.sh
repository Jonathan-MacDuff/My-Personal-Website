...
# NEW: Build to server/static instead of client/public
rm -rf ../../server/static/cat-meme-generator/*
mkdir -p ../../server/static/cat-meme-generator
cp -r build/* ../../server/static/cat-meme-generator/
